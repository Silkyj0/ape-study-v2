  ...
  return (
    <div>
      <div className="mb-4 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs leading-relaxed text-slate-600">
        Question order and answer order are shuffled for every study session. Modules 1 and 2 use a smaller curated bank, while Module 3 is built directly from the connected Acumen source folder. PARCS sample questions remain locked and unchanged.
      </div>
      ...
      >
        <div>
          ...
          <div className="mt-1 text-xs text-indigo-700">Source-audited M1/M2 + Drive-verified M3 · excludes the {parcsCount} locked PARCS samples · shuffled each run</div>
        </div>
